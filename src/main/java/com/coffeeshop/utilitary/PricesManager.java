...
public class PricesManager {
    private static Map<Ingredients, Double> pricesForEachIngredient;
    /**
     * @return dictionary where key is an ingredient and value is the price for 1 unit of that ingredient
     */
    public static Map<Ingredients, Double> getPricesForIngredients() {
        if(pricesForEachIngredient == null) {
